...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<String> sendData() async {
    http.Response response = await http.get(
      Uri.encodeFull(
          "https://ps.pndsn.com/publish/pub-c-b3c97c3a-4572-44ac-91d4-942e9dcecc86/sub-c-052a7e96-86f4-11e9-9f15-ba4fa582ffed/0/flutter_iot_lamp/0/{\"action\":$statusLight}?uuid=db9c5e39-7c95-40f5-8d71-125765b6f561"),
    );
                    ...
                    children: <Widget>[
                      ...
                      Text('Ventilador',
                          style: TextStyle(
                              ...
                              fontSize: 22.0)),
                      Text('Ligado', style: TextStyle(color: Colors.black45)),
                    ]),
              ),
            ),
            _buildTile(
                      ...
                      children: <Widget>[
                        ...
                        Text('Balada',
                            style: TextStyle(
                                ...
                                fontWeight: FontWeight.w700,
                                fontSize: 22.0)),
                        Text('Off', style: TextStyle(color: Colors.black45)),
                      ]),
                ), callback: () {
              setState(() {
